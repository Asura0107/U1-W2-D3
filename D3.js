...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const newObj = starWarsCharacters[i];
  characters.push(newObj.name);
}
...
*/
// quando c'è "ogni" è meglio usare un for
for (let i = 0; i < starWarsCharacters.length; i++) {
...
if (crewMass <= 500) {
  ...
  console.log("Crew value not recognized");
}
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  let megaBot = starWarsCharacters[i];
  if (megaBot.gender === "n/a") {
    megaBot.gender = "robot";
  }
}
