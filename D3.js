...
switch (eyeColor) {
  case "blue":
    blue.push(starWarsCharacters[(0, 5, 6)]);
    console.log(blue);
    break;

  case "yellow":
    blue.push(starWarsCharacters[(1, 3)]);
    console.log(yellow);
    break;

  case "brown":
    blue.push(starWarsCharacters[(4, 8)]);
    console.log(brown);
    break;

  case "red":
    blue.push(starWarsCharacters[(2, 7)]);
    console.log(red);
    break;

  case "bluegray":
    blue.push(starWarsCharacters[9]);
    console.log(bluegray);
    break;
}
